...
contract TokenConfig is Script, Parameters {
    ...
    function run() external view returns (Token memory token){
        if (block.chainid == ETHRREUM_SEPOLIA_CHAIN_ID) {
    ...
    function getAvalancheFujiToken() public pure returns (Token memory token){
        ...
        token.glm = BaseToken(AVALANCHE_FUJI_CHAIN_SELECTOR, AVALANCHE_FUJI_GLM, GLM_PRICE_FEED);
    ...
    function getEthereumSepoliaToken() public pure returns (Token memory token){
        ...
        token.glm = BaseToken(ETHEREUM_SEPOLIA_CHAIN_SELECTOR, ETHEREUM_SEPOLIA_GLM, GLM_PRICE_FEED);
    ...
    function getArbitrumSepoliaToken() public pure returns (Token memory token){
        ...
        token.glm = BaseToken(ARBITRUM_SEPOLIA_CHAIN_SELECTOR, ARBITRUM_SEPOLIA_GLM, GLM_PRICE_FEED);
    ...
    function getPolygonAmoyToken() public pure returns (Token memory token){
        ...
        token.glm = BaseToken(POLYGON_AMOY_CHAIN_SELECTOR, POLYGON_AMOY_GLM, GLM_PRICE_FEED);
    ...
    function getBaseSepoliaToken() public pure returns (Token memory token){
        ...
        token.glm = BaseToken(BASE_SEPOLIA_CHAIN_SELECTOR, BASE_SEPOLIA_GLM, GLM_PRICE_FEED);
    ...
    function getOptimismSepoliaToken() public pure returns (Token memory token){
        ...
        token.glm = BaseToken(OPTIMISM_SEPOLIA_CHAIN_SELECTOR, OPTIMISM_SEPOLIA_GLM, GLM_PRICE_FEED);
