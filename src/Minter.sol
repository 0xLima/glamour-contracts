...
contract Minter is CCIPBase {
    ...
    function burn(uint256 _amount) external payable {
        ...
        IERC20(address(gm)).safeTransferFrom(msg.sender, address(this), _amount);
        gm.burn(_amount);
    ...
    function liquidate(
        ...
        feePay[msg.sender] += msg.value;
        IERC20(address(gm)).safeTransferFrom(msg.sender, address(this), _amountToCover);
        gm.burn(_amountToCover);
    ...
    function getGm() public view returns (GM) {
        return gm;
    }
